...
class CablePlot(AxesBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.series = dict()
        (self.series["temp"],) = self.plot(
            self.figure.parent.array[self.figure.parent.t_loc, :], color="blue"
        )
        ...
        self.series["minmax"] = self.fill_between(
            range(len(min)), min, max, **minmax_opts
        )
