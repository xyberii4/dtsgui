        ...
        try:
            if data is not None:
                ...
                if "Easting" in fields and "Northing" in fields:
                    ...
                    raise ValueError(
                        "Must set either Easting and Northing or Latitude and Longitude."
                    )
                ...
                event = dts.ui.evt.GeodataImportedEvent(
                    -1,
                    raw_data=data,
...
def import_geodata(parent=None):
    ...
    dlg = wx.FileDialog(
        parent,
        "Choose a file with geospatial coordinates",
        ".",
        "",
...
class UTMTransformer:
    def __init__(self, zone):
        ...
        self.utm_coordinate_system.SetWellKnownGeogCS(
            "WGS84"
        )  # Set geographic coordinate system to handle lat/lon

        self.wgs84_coordinate_system = (
            self.utm_coordinate_system.CloneGeogCS()
    ...
    def to_latlon(self, easting, northing):
        ...
        self.utm_to_wgs84_transform = osr.CoordinateTransformation(
            self.utm_coordinate_system, self.wgs84_coordinate_system
        )
